...
namespace Scope
{
    class Scope
    {
        ...
        static void Main(string[] args)
        {
            ...
            // class Scopes static variable x retains its value
            UseStaticVariable();
        ...
        public static void UseLocalVariable()
        {
            ...
            Console.WriteLine("\nlocal x on entering method UseLocalVariable " +
                "is {0}", x);
            ++x;            // modifies this method's local variable x
            Console.WriteLine("local x before exiting method UseLocalVariable " +
                "is {0}", x);
